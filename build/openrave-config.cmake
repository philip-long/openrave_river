...
if( MSVC )
  ...
  set(OpenRAVE_LIBRARY_SUFFIX "0.9" CACHE STRING "the suffix for the openrave libraries" FORCE)
endif()
...
set( OpenRAVE_INCLUDE_DIRS "${OpenRAVE_ROOT_DIR}/include/openrave-0.9")
set( OpenRAVE_LIBRARY_DIRS "${OpenRAVE_ROOT_DIR}/lib")
set( OpenRAVE_LIBRARIES openrave${OpenRAVE_LIBRARY_SUFFIX})
set( OpenRAVE_CORE_LIBRARIES ${OpenRAVE_LIBRARIES} openrave${OpenRAVE_LIBRARY_SUFFIX}-core)
# c-bindings only
set( OpenRAVE_C_LIBRARIES openrave${OpenRAVE_LIBRARY_SUFFIX}_c)
set( OpenRAVE_CORE_C_LIBRARIES ${OpenRAVE_LIBRARIES}_c openrave${OpenRAVE_LIBRARY_SUFFIX}-core_c)
...
set( OpenRAVE_Boost_VERSION "1.54")
