...
if __name__ == "__main__":
    ...
    parser.add_option('--database', action="callback",callback=vararg_callback, dest='database',default=None,
                      help='If specified, the next arguments will be used to call a database generator from the openravepy.databases module. The first argument is used to find the database module. For example: openrave0.9.py --database grasping --robot=robots/pr2-beta-sim.robot.xml')
    parser.add_option('--example', action="callback",callback=vararg_callback, dest='example',default=None,
                      help='If specified, the next arguments will be used to call an example from the openravepy.examples module. The first argument is used to find the example moduel. For example: openrave0.9.py --example graspplanning --scene=data/lab1.env.xml')
